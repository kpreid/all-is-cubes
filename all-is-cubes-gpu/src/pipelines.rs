...
impl Pipelines {
    ...
    pub fn new(
        ...
        let block_render_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                ...
                bind_group_layouts: &[
                    ...
                    Some(&space_texture_bind_group_layout),
                    Some(&blocks_static_bind_group_layout),
                ],
                immediate_size: 0,
            });
            ...
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                ...
                layout: Some(
                    &device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                        ...
                        bind_group_layouts: &[Some(&rt_frame_copy_layout)],
                        immediate_size: 0,
                    }),
                ),
                vertex: wgpu::VertexState {
        ...
        let rerun_copy_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            layout: Some(
                &device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    ...
                    bind_group_layouts: &[Some(&rerun_copy_layout)],
                    immediate_size: 0,
                }),
            ),
            vertex: wgpu::VertexState {
        ...
        let (info_text_font, info_text_font_metrics) = crate::text::generate_texture_atlas(
            device,
            queue,
            &all_is_cubes::block::text::Font::System16,
        );
        ...
        let blocks_static_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: wgpu::BindingResource::Sampler(&block_linear_sampler),
                },
            ],
        });
