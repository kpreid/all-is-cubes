                ...
                "SpaceMesh {
                    ...
                    meta: MeshMeta {
                        ...
                        transparent: [
                            ...
                            54..78 [0..12] sorted for EMPTY,
                            78..96 [] sorted for EVERYWHERE,
                            96..120 [0..12] sorted for EMPTY,
                            120..150 [0..18] sorted for EMPTY,
                            150..174 [0..12] sorted for EMPTY,
                            174..192 [] sorted for EVERYWHERE,
                            192..216 [0..12] sorted for EMPTY,
                            216..234 [] sorted for EVERYWHERE,
                            234..258 [0..12] sorted for EMPTY,
                            258..288 [0..18] sorted for EMPTY,
                            288..312 [0..12] sorted for EMPTY,
                            312..342 [0..18] sorted for EMPTY,
                            0..36 [0..36] sorted for EMPTY,
                            342..372 [0..18] sorted for EMPTY,
                            372..396 [0..12] sorted for EMPTY,
                            396..426 [0..18] sorted for EMPTY,
                            426..450 [0..12] sorted for EMPTY,
                            450..468 [] sorted for EVERYWHERE,
                            468..492 [0..12] sorted for EMPTY,
                            492..510 [] sorted for EVERYWHERE,
                            510..534 [0..12] sorted for EMPTY,
                            534..564 [0..18] sorted for EMPTY,
                            564..588 [0..12] sorted for EMPTY,
                            588..606 [] sorted for EVERYWHERE,
                            606..630 [0..12] sorted for EMPTY,
