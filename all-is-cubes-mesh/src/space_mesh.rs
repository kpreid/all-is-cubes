...
type BlockIndexSet = crate::BitSet<BlockIndex>;
...
pub struct SpaceMesh<M: MeshTypes> {
    ...
    block_indices_used: BlockIndexSet,
}
...
impl<M: MeshTypes> SpaceMesh<M> {
    ...
    fn store_indices_and_finish_compute(
        ...
        self.meta.opaque_range = 0..IndexBound::try_from(self.indices.len()).err_is_unreachable();
...
impl<M: MeshTypes> fmt::Debug for SpaceMesh<M> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        s.field("meta", meta);
        s.field("block_indices_used", block_indices_used);
        s.finish()
    }
}
...
impl<M: MeshTypes> Default for SpaceMesh<M> {
    ...
    fn default() -> Self {
        Self {
            ...
            block_indices_used: BlockIndexSet::new(),
        }
    }
}
